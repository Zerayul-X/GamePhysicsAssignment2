...
void StartScene::start()
{
	...
	m_pTitleLabel = new Label("Physics", "Consolas", 125, blue, glm::vec2(500.0f, 100.0f));
	m_pTitleLabel->setParent(this);
	addChild(m_pTitleLabel);

	m_pStartLabel = new Label("Assignment 2 - Friction Motion", "Consolas", 40, blue, glm::vec2(500.0f, 200.0f));
